...
def get_result():
    ...
    if operator == '+':
        ...
        if second_number == 0:
            result_label.config(text='infinity')
        else:
            result_label.config(text=round(first_number/second_number))
...
btn_clr = Button(root,text='AC',bg='#00a65a',fg='white',width=5,height=2,command=lambda:clear())
